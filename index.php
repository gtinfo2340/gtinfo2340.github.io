			...
			<div class="panel panel-info" style="">
				...
				<div class="panel-body">
					 ...
					 <form class="form-horizontal" method="POST" id="login_form">
									...
									<button type="submit" class="btn btn-info">Ingresar</button> <br>
									</div>

									<div class="col-sm-12">
										<div class="alert alert-success" id="correct"> Acceso Aprobado!</div>
										<div class="alert alert-danger" id="error"> Contraseña Incorrecta </div>
									</div>
									</div>
